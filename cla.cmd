...
>&2 echo + claude --plugin-dir "%PLUGIN_DIR%" --permission-mode auto --model opus --effort medium %*
call claude --plugin-dir "%PLUGIN_DIR%" --permission-mode auto --model opus --effort medium %*
