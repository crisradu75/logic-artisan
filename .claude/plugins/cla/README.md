...
Bash/PowerShell matcher, 2 on Edit/Write) — plus `warn-wholesale-rewrite` wired directly on
PostToolUse: 8 leaf hook files in all. They run throughout every phase.
