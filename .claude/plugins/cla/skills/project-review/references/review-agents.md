...
> 4. i18n architecture — is all user-facing text routed through the translation-key mechanism (every i18n layer)? Are any load-bearing enum-like values (e.g. dayparts) carried as keys end-to-end?
