...
- **If the task is self-contained and can be delegated to a subagent** (doesn't need
  ...
  `${CLAUDE_PLUGIN_ROOT}/skills/_shared/references/model-routing.md` for the live
