...
- **No reverse propagation.** This skill pulls *to* the local repo only. To push a local improvement back upstream, run the skill in the upstream repo with this repo as the source.
