...
Parallel batch 2 — After reading artifacts, run ALL verification checks simultaneously. Most verification checks (0a–0i and 1–9 below) require reading source — do so freely; don't gate on the artifacts alone.
...
All checks above (generic 0a–0e here, plus the overlay's 0f–0i and 1–9) are run by the orchestrator (you), not by agents. Record results in the **context brief** below.
