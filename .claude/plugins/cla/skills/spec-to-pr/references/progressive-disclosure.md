...
- **Conformance guard** — `python3 -m pytest .claude/plugins/cla/skills/update-cla/tests/test_no_project_tokens.py -q` MUST pass (no repo token leaked into a new synced-core reference).
